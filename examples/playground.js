...
// Add a square
const square = new Square(new Position(100, 200), 100, {
    fill: "#666",
    stroke: "#333",
    strokeWidth: 2,
});
...
// Add a circle
const underCirc = new Circle(new Position(), 15, {
    fill: "#a01c90",
...
const circ = new Circle(new Position(250, 150), 100, {
    fill: "#D55",
    alpha: 0.7,
});
scene.addChild(circ);
...
circ.on("hover", () => circ.options.alpha = 1).on("leave", () => circ.options.alpha = 0.7);

const subCircV = new Circle(new Position(0, 50), 20, {
    fill: "#EE5",
    cursor: "ns-resize",
});
...
const subCircH = new Circle(new Position(), 20, {
    fill: "#EE5",
    cursor: "ew-resize",
});
...
const line = new Line(subCircV.position, subCircH.position, {
    stroke: "#FFF",
    strokeWidth: 5,
});
circ.addChild(line);
...
// Add some text
const text = new Text(new Position(150, 500), "Holy shit !", {
    fill: null,
    stroke: "#0AE",
    strokeWidth: 2.5,
    fontSize: 50,
...
// Add a star
const star = new Star(new Position(text.width / 2, text.height / 2), 100, undefined, undefined, {
    fill: null,
    stroke: "gold",
    strokeWidth: 10,
    zIndex: -1,
